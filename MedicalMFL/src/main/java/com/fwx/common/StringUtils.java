...
public class StringUtils {
     ...
     * @since JDK 1.8
     */
    public static String getPicSuffix(String imgPath ,Boolean isPiont) {
        ...
        if (isPiont) {
            ...
            return imgPath.substring(imgPath.lastIndexOf(".") + 1).trim().toLowerCase();
        }
    }

    /**
     * 方法功能说明：获取图片URL的图片文件名
     * 创建日期：2017年8月31日
     * 创建者： wangjie
     * @param imgPath
     * @return String
     */
    public static String getPicName(String imgPath) {
        if (imgPath == null || imgPath.indexOf(".") == -1) {
            return "";
        }
        return imgPath.substring(imgPath.lastIndexOf("/") + 1).trim();
    }

    /**
     *
     * likeEscape:替换sql文中like通配符. <br/>
     *
