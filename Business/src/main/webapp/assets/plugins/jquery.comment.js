(function($){
	function crateCommentInfo(obj){
		...
		var el = "<div class='comment-info'><header><img src='"+obj.userImg+"'></header><div class='comment-right'><h3 replyId='" + obj.replyId + "'>"+obj.replyName+"</h3>"
	...
	function replyClick(el){
		...
		.find(".send").click(function(){
			...
			if(content != ""){
				...
				var obj = new Object();
				obj.replyName=localStorage.username;
				...
				obj.content=content;
				obj.goodsId=productId;
				obj.time = getNowDateFormat();
				obj.browse = getExplorerInfo().type;
				obj.osname = osType();
				obj.beReplyId = parentEl.find("h3").attr('replyId');
				addComment(obj);
				var replyString = createReplyComment(obj);
				//alert("获取到的id是:"+obj.goodsId);
				$(".replybox").remove();
